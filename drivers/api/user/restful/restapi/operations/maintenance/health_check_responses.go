...
type HealthCheckOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.ServiceHealth `json:"body,omitempty"`
}
...
func (o *HealthCheckOK) WithPayload(payload *models.ServiceHealth) *HealthCheckOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the health check o k response
func (o *HealthCheckOK) SetPayload(payload *models.ServiceHealth) {
	o.Payload = payload
}
...
// WithContentLanguage adds the contentLanguage to the health check default response
func (o *HealthCheckDefault) WithContentLanguage(contentLanguage string) *HealthCheckDefault {
	o.ContentLanguage = contentLanguage
	return o
}

// SetContentLanguage sets the contentLanguage to the health check default response
func (o *HealthCheckDefault) SetContentLanguage(contentLanguage string) {
	o.ContentLanguage = contentLanguage
}
